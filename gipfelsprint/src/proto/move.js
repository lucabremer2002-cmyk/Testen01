...
(function (root) {
  ...
  function create(level) {
    ...
    p.step = function (dt, cmd) {
      ...
      if (this.sliding) this.slideTime += dt; else this.slideTime = 0;
      ...
      if (this.dashTimer > 0) {
        ...
        if (sp > cap && sp > 0.001) {
          var decay = (this.sliding ? P.OVER_DECAY_SLIDE
  ...
  root.MR = root.MR || {};
  root.MR.protoMove = { create: create, createCamera: createCamera, TUNING: P };
})(window);
