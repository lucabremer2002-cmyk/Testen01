...
(function (global) {
  ...
  var DRITTE_LIGA = [
    ...
    ['waldhof', 'SV Waldhof Mannheim', 'WAL', 'Mannheim', 'Carl-Benz-Stadion', 25667, 37],
  ...
  var EUROPA = [
    ...
    ['FC Barcelona', 'Spanien', 94, 'BAR'], ['FC Liverpool', 'England', 93, 'LIV'],
    ...
    ['Sporting Lissabon', 'Portugal', 82, 'SPO'], ['Ajax Amsterdam', 'Niederlande', 79, 'AJA'],
    ...
    ['FC Kopenhagen', 'Dänemark', 68, 'KOP'], ['FC Midtjylland', 'Dänemark', 66, 'MID'],
